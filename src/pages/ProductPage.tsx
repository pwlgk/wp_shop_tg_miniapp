...
export const ProductPage = () => {
  ...
  if (isError || !product) { return <div className="p-4 text-center"> <h1 className="text-3xl font-bold">Произошла ошибка</h1> <p className="text-muted-foreground mt-2">{error?.message || 'Не удалось загрузить товар'}</p> </div>; }
        ...
        <div className="px-4 space-y-6">
          ...
          {hasDescription && (
            <div className="pt-4 border-t">
                <h2 className="font-semibold mb-2 text-xl break-words">Описание</h2>
          ...
          {showReviewsSection && (
            <div id="reviews-section" className="border-t pt-6 space-y-4">
              <div className="flex justify-between items-center">
                  <h2 className="text-xl font-bold">Отзывы ({product.rating_count})</h2>
                  {product.can_review && (
